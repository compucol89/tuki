...
> Fuente: https://getbootstrap.com/docs/4.3/components/navs/
...
Change the horizontal alignment of your nav with [flexbox utilities](/docs/4.3/layout/grid/#horizontal-alignment). By default, navs are left-aligned, but you can easily change them to center or right aligned.
...
Add dropdown menus with a little extra HTML and the [dropdowns JavaScript plugin](/docs/4.3/components/dropdowns/#usage).
