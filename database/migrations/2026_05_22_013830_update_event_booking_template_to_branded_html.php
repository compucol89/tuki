...
{
    /**
     * Update event_booking template to branded HTML with corporate design.
     */
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="badge">Evento confirmado</div>
    </div>
    <div class="body">
