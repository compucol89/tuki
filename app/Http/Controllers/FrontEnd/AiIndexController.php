...
class AiIndexController extends Controller
{
  ...
  public function llms()
  {
    ...
    $lines = [
      ...
      '',
      'Tukipass opera comercialmente por ' . config('tukipass.fiscal.issuer_name') . ', CUIT ' . config('tukipass.fiscal.issuer_cuit') . '. Tukipass no organiza ni produce los eventos publicados, salvo indicación expresa; la realización, calidad, accesos, horarios, cambios, cancelaciones, reembolsos y condiciones particulares son responsabilidad exclusiva del organizador.',
      '',
  ...
  public function full()
  {
    ...
    $lines = [
      ...
      '',
      'Entidad operadora: ' . config('tukipass.fiscal.issuer_name') . ', CUIT ' . config('tukipass.fiscal.issuer_cuit') . '.',
      '',
