            ...
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="eventForm" action="{{ route('admin.event_management.store_event') }}" method="POST"
                          ...
                          @endif
                            ...
                            @endif
	                          ...
	                          <div class="event-advanced-section mb-4">
                                ...
                                data-target="#eventSeoCreateAdmin{{ $language->id }}" aria-expanded="false"
                                aria-controls="eventSeoCreateAdmin{{ $language->id }}">
                                <span>
                              ...
                              <div id="eventSeoCreateAdmin{{ $language->id }}" class="collapse event-advanced-body">
	                            <div class="row">
	                              <div class="col-lg-12">
                ...
                <div class="card ev-section-card event-optional-card mt-4">
                  <div class="card-header ev-section-header">
                    <button type="button" class="event-optional-toggle collapsed" data-toggle="collapse"
                      data-target="#eventMediaCreateAdmin" aria-expanded="false" aria-controls="eventMediaCreateAdmin">
                      <span>
                  ...
                  <div class="card-body collapse" id="eventMediaCreateAdmin">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                ...
                <div class="card ev-section-card event-optional-card mt-4">
                  <div class="card-header ev-section-header">
                    <button type="button" class="event-optional-toggle collapsed" data-toggle="collapse"
                      data-target="#eventTrackingCreateAdmin" aria-expanded="false" aria-controls="eventTrackingCreateAdmin">
                      <span>
                  ...
                  <div class="card-body collapse" id="eventTrackingCreateAdmin">
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
