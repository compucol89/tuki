            ...
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="eventForm" action="{{ route('organizer.event_management.store_event') }}" method="POST"
                ...
                <div class="row" id="single_dates">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
	                      ...
	                      <input type="date" name="end_date" placeholder="{{ __('Fecha de fin') }}" class="form-control">
                    </div>
                  </div>
                ...
                @endif
                  ...
                  @php $singleLanguageMode = isset($languages) && count($languages) === 1; @endphp
                          ...
                          @endif
	                            ...
	                            <div class="col">
	                              <div class="form-group">
	                                ...
	                                <textarea id="descriptionTmce{{ $language->id }}" class="form-control summernote"
	                                  name="{{ $language->code }}_description" placeholder="{{ __('Contá de qué se trata el evento, qué incluye la entrada, horarios, accesos y datos importantes.') }}" data-height="300"></textarea>
	                              </div>
	                            </div>
	                          </div>
                            ...
                            @endif
	                          ...
	                          <div class="event-advanced-section mb-4">
                                ...
                                data-target="#eventSeoCreateOrganizer{{ $language->id }}" aria-expanded="false"
                                aria-controls="eventSeoCreateOrganizer{{ $language->id }}">
                                <span>
                              ...
                              <div id="eventSeoCreateOrganizer{{ $language->id }}" class="collapse event-advanced-body">
	                            <div class="row">
	                              <div class="col-lg-12">
...
@section('style')
  <style>
    ...
    .event-cover-box__upload {
      ...
      margin: 0;
      padding: 14px 16px;
      border: 1px dashed var(--status-info-bg);
      border-radius: 16px;
    ...
    .event-content-panel .version-header {
      background: linear-gradient(180deg, var(--surface-card-soft) 0%, var(--surface-card-soft) 100%);
    ...
    /* Dark overrides — formulario de creación de evento (Fase A) */
    html[data-theme="dark"] .create-cover-ai-requirement.is-ready strong {
      background: var(--status-success-bg);
      color: var(--status-success-fg);
    }

    html[data-theme="dark"] .create-cover-ai-requirement.is-ready {
      border-color: var(--border-default);
    }

    html[data-theme="dark"] .event-cover-box__state i,
    html[data-theme="dark"] .event-cover-box__state strong,
    html[data-theme="dark"] .event-cover-box__state span {
      color: var(--status-success-fg);
    }

    html[data-theme="dark"] .async-progress-panel.is-success {
      background: var(--surface-card-soft);
      border-color: var(--border-default);
    }

    html[data-theme="dark"] .async-progress-panel.is-success .progress-bar {
      background-color: var(--status-success-fg);
    }
