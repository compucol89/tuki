                  ...
                  @else
                    @if ($organizer->photo == null)
                      <picture>
                        ...
                        <img class="rounded-lg lazy" data-src="{{ asset('assets/front/images/user.png') }}" alt="{{ __('Perfil del organizador') }}" loading="lazy">
                      </picture>
                    @else
                      <img class="rounded-lg lazy"
                        data-src="{{ asset('assets/admin/img/organizer-photo/' . $organizer->photo) }}" alt="{{ __('Perfil del organizador') }}" loading="lazy">
                    @endif
                  @endif
                </a>
              </figure>
