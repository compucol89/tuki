...
> Fuente: https://getbootstrap.com/docs/4.5/components/collapse/
...
[View on GitHub](https://github.com/twbs/bootstrap/blob/v4.5.3/site/docs/4.5/components/collapse.md "View and edit this file on GitHub")
...
Using the [card](/docs/4.5/components/card/) component, you can extend the default collapse behavior to create an accordion. To properly achieve the accordion style, be sure to use `.accordion` as a wrapper.
