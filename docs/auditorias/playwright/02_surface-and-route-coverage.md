...
- Credenciales `E2E_ORGANIZER_USERNAME/PASSWORD` en **env, no versionadas**; defaults CI 'Rumba Colombiana'/'1234567890' (seed tukipass.sql) — **coinciden con la DB local** (verificado: @theme pasa 16/16 localmente con esos valores). No aparecen en logs/traces de las corridas observadas. Riesgo bajo; sensibles a sobrescritura vía secrets ✓.
