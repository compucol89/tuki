...
<div class="event-edit-page">
  ...
  {{-- Gallery card (standalone form — AJAX dropzone) --}}
  <div class="card mb-3">
    <div class="card-header">
      <h4 class="card-title"><i class="fas fa-images mr-2"></i>{{ __('Gallery Images') }}</h4>
    </div>
    <div class="card-body">
      ...
      <p class="text-warning small mt-2 mb-0">{{ __('Image Size : 1170 x 570') }}</p>
    </div>
  </div>
  ...
  <form id="eventForm" action="{{ route('admin.event.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-image mr-2"></i>{{ __('Thumbnail Image') }}</h4>
          </div>
          <div class="card-body">
            <div class="d-flex align-items-start">
              <div class="thumb-preview mr-4">
                <img
                  ...
                  alt="..." class="uploaded-img" style="max-height:120px; border-radius:6px;">
              </div>
              <div>
        ...
        {{-- Card: Event content (language accordion) --}}
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-file-alt mr-2"></i>{{ __('Contenido del evento') }}</h4>
          </div>
          <div class="card-body">
            <div id="accordion">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="{{ $language->code }}_zip_code"
                                class="form-control {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
                                placeholder="Enter Zip/Post Code" value="{{ @$event_content->zip_code }}">
                            </div>
                          </div>
                        </div>
                      @endif
        ...
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-music mr-2"></i>{{ __('Multimedia del Artista') }}</h4>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <small class="text-muted">{{ __('Abrí Spotify → tres puntos → Compartir → Copiar enlace del artista.') }}</small>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <small class="text-muted">{{ __('Pegá el enlace tal como aparece en el navegador.') }}</small>
                </div>
              </div>
            </div>
          </div>
        ...
        {{-- Card: Tracking pixels --}}
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-chart-line mr-2"></i>{{ __('Píxeles de Seguimiento') }}</h4>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="meta_pixel_id" value="{{ $event->meta_pixel_id }}"
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="google_analytics_id" value="{{ $event->google_analytics_id }}"
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tiktok_pixel_id" value="{{ $event->tiktok_pixel_id }}"
      ...
      <div class="col-lg-4">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-cog mr-2"></i>{{ __('Publicación') }}</h4>
          </div>
          <div class="card-body">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <small class="text-muted">{{ __('Automático: el sistema asigna badge por visitas/ventas/stock.') }}</small>
            </div>
          </div>
        </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-user mr-2"></i>{{ __('Organizador') }}</h4>
          </div>
          <div class="card-body">
            <div class="form-group mb-0">
              ...
              <small class="text-muted">{{ __('Dejá vacío para evento del Admin') }}</small>
            </div>
          </div>
        </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <h4 class="card-title"><i class="fas fa-calendar-alt mr-2"></i>{{ __('Fechas y horarios') }}</h4>
          </div>
          <div class="card-body">
            ...
            <div class="countDownStatus {{ $event->date_type == 'multiple' ? 'd-none' : '' }}">
              <div class="form-group">
            ...
            {{-- Single dates --}}
            <div class="{{ $event->date_type == 'multiple' ? 'd-none' : '' }}" id="single_dates">
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
            ...
            {{-- Multiple dates --}}
            <div class="{{ $event->date_type == 'single' ? 'd-none' : '' }}" id="multiple_dates">
                ...
                <table class="table table-bordered table-sm">
                  <thead>
                    <tr>
                      ...
                      <th>{{ __('End Time') }}</th>
                      <th>
                        <a href="javascript:void(0)" class="btn btn-success btn-sm addDateRow">
                  ...
                  <tbody>
                    @if (count($event_dates) > 0)
                      @foreach ($event_dates as $date)
                        <tr>
                          <td><input type="date" name="m_start_date[]" class="form-control form-control-sm" value="{{ $date->start_date }}"></td>
                          <td><input type="time" name="m_start_time[]" class="form-control form-control-sm" value="{{ $date->start_time }}"></td>
                          <td><input type="date" name="m_end_date[]" class="form-control form-control-sm" value="{{ $date->end_date }}"></td>
                          <td><input type="time" name="m_end_time[]" class="form-control form-control-sm" value="{{ $date->end_time }}"></td>
                          <input type="hidden" name="date_ids[]" value="{{ $date->id }}">
                          <td>
                            <a href="javascript:void(0)" data-url="{{ route('admin.event.delete.date', $date->id) }}"
                              class="btn btn-danger btn-sm deleteDateDbRow">
                    ...
                    @else
                      <tr>
                        <td><input type="date" name="m_start_date[]" class="form-control form-control-sm"></td>
                        <td><input type="time" name="m_start_time[]" class="form-control form-control-sm"></td>
                        <td><input type="date" name="m_end_date[]" class="form-control form-control-sm"></td>
                        <td><input type="time" name="m_end_time[]" class="form-control form-control-sm"></td>
                        <td>
                          <a href="javascript:void(0)" class="btn btn-danger btn-sm deleteDateRow">
                            <i class="fas fa-minus"></i>
                          </a>
                        </td>
                      </tr>
        ...
        {{-- Card: Ubicación (venue only) --}}
        @if ($event->event_type == 'venue')
          <div class="card mb-3">
            <div class="card-header">
              <h4 class="card-title"><i class="fas fa-map-marker-alt mr-2"></i>{{ __('Ubicación GPS') }}</h4>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-6">
                  <div class="form-group mb-0">
                    ...
                    <input type="text" name="latitude" value="{{ $event->latitude }}" class="form-control" placeholder="Latitude">
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group mb-0">
                    <label>{{ __('Longitude') }}</label>
                    <input type="text" name="longitude" value="{{ $event->longitude }}" class="form-control" placeholder="Longitude">
                  </div>
                </div>
              </div>
            </div>
        ...
        {{-- Card: Tickets y precio (online only) --}}
        @if ($event->event_type == 'online')
          <div class="card mb-3">
            <div class="card-header">
              <h4 class="card-title"><i class="fas fa-ticket-alt mr-2"></i>{{ __('Tickets y precio') }}</h4>
            </div>
            <div class="card-body">
              ...
              <div class="{{ @$event->ticket->ticket_available_type == 'limited' ? '' : 'd-none' }}" id="ticket_available">
                <div class="form-group">
              ...
              @if ($websiteInfo->event_guest_checkout_status != 1)
                ...
                <div class="{{ @$event->ticket->max_ticket_buy_type == 'limited' ? '' : 'd-none' }}" id="max_buy_ticket">
                  <div class="form-group">
                    <label>{{ __('Enter Maximum number of tickets for each customer') }}*</label>
                    <input type="number" name="max_buy_ticket" class="form-control"
              ...
              <div class="form-group">
                ...
                <div class="mt-2">
                  <input type="checkbox" name="pricing_type"
                    ...
                    value="free" id="free_ticket">
                  <label for="free_ticket" class="mb-0">{{ __('Tickets are Free') }}</label>
                </div>
              </div>
              ...
              {{-- Early bird discount --}}
              <div class="{{ optional($event->ticket)->pricing_type == 'free' ? 'd-none' : '' }}" id="early_bird_discount_free">
                <div class="form-group">
                ...
                <div class="{{ optional($event->ticket)->early_bird_discount == 'disable' ? 'd-none' : '' }}" id="early_bird_dicount">
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <button type="submit" id="EventSubmit" class="btn btn-primary btn-block">
