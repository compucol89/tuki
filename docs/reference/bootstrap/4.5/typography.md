...
> Fuente: https://getbootstrap.com/docs/4.5/content/typography/
...
[View on GitHub](https://github.com/twbs/bootstrap/blob/v4.5.3/site/docs/4.5/content/typography.md "View and edit this file on GitHub")
...
Bootstrap sets basic global display, typography, and link styles. When more control is needed, check out the [textual utility classes](/docs/4.5/utilities/text/).

  * Use a [native font stack](/docs/4.5/content/reboot/#native-font-stack) that selects the best `font-family` for each OS and device.
...
Change text alignment, transform, style, weight, and color with our [text utilities](/docs/4.5/utilities/text/) and [color utilities](/docs/4.5/utilities/colors/).
