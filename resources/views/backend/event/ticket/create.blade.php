        ...
        <div class="card-header">
          <div class="ticket-form-header">
            <div class="ticket-form-header__intro">
              ...
              <p class="ticket-form-header__text">{{ __('Define el precio, el cupo y el nombre de la entrada para que quede claro que se vende y como se limita la compra.') }}</p>
            </div>
            <div class="ticket-form-header__actions">
              ...
              <a class="btn btn-info ticket-form-header__btn"
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                ...
                                <textarea class="form-control" name="{{ $language->code }}_description" placeholder="{{ __('Ej: Incluye acceso general al evento.') }}"></textarea>
                              </div>
                            </div>
                          </div>
