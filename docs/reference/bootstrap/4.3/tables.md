...
> Fuente: https://getbootstrap.com/docs/4.3/content/tables/
...
Regular table background variants are not available with the dark table, however, you may use [text or background utilities](/docs/4.3/utilities/colors/) to achieve similar styles.
