...
> Fuente: https://getbootstrap.com/docs/4.3/components/card/
...
Use our handful of [available sizing utilities](/docs/4.3/utilities/sizing/) to quickly set a card’s width.
...
You can quickly change the text alignment of any card—in its entirety or specific parts—with our [text align classes](/docs/4.3/utilities/text/#text-alignment).
...
Add some navigation to a card’s header (or block) with Bootstrap’s [nav components](/docs/4.3/components/navs/).
...
Use [text and background utilities](/docs/4.3/utilities/colors/) to change the appearance of a card.
...
Use [border utilities](/docs/4.3/utilities/borders/) to change just the `border-color` of a card. Note that you can put `.text-{color}` classes on the parent `.card` or a subset of the card’s contents as shown below.
