...
> Fuente: https://getbootstrap.com/docs/4.5/components/dropdowns/
...
Place any freeform text within a dropdown menu with text and use [spacing utilities](/docs/4.5/utilities/spacing/). Note that you’ll likely need additional sizing styles to constrain the menu width.
...
Put a form within a dropdown menu, or make it into a dropdown menu, and use [margin or padding utilities](/docs/4.5/utilities/spacing/) to give it the negative space you require.
