...
> Fuente: https://getbootstrap.com/docs/4.5/components/card/
...
[View on GitHub](https://github.com/twbs/bootstrap/blob/v4.5.3/site/docs/4.5/components/card.md "View and edit this file on GitHub")
...
Use our handful of [available sizing utilities](/docs/4.5/utilities/sizing/) to quickly set a card’s width.
...
You can quickly change the text alignment of any card—in its entirety or specific parts—with our [text align classes](/docs/4.5/utilities/text/#text-alignment).
...
Add some navigation to a card’s header (or block) with Bootstrap’s [nav components](/docs/4.5/components/navs/).
...
Use [text and background utilities](/docs/4.5/utilities/colors/) to change the appearance of a card.
...
Use [border utilities](/docs/4.5/utilities/borders/) to change just the `border-color` of a card. Note that you can put `.text-{color}` classes on the parent `.card` or a subset of the card’s contents as shown below.
...
Use the Bootstrap grid system and its [`.row-cols` classes](/docs/4.5/layout/grid/#row-columns) to control how many grid columns (wrapped around your cards) you show per row. For example, here’s `.row-cols-1` laying out the cards on one column, and `.row-cols-md-2` splitting four cards to equal width across multiple rows, from the medium breakpoint up.
