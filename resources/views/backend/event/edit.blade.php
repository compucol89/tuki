    ...
    <div class="col-lg-8 offset-lg-2">
          ...
          @else
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3">
              <div class="mb-3 mb-md-0">
                ...
                <p class="text-muted mb-0">{{ __('Usá esta guía para revisar rápido si el evento ya se entiende bien y está listo para vender.') }}</p>
              </div>
              <div class="text-md-right">
      ...
      <div class="card ev-section-card event-media-card" id="section-media">
        ...
        <div class="card-body">
          ...
          <p class="text-muted small mt-2 mb-4">{{ __('JPG, PNG o WebP. Mínimo aceptado: 600x450. Estas imágenes no reemplazan la portada.') }}</p>
        </div>
      </div>
      ...
      <form id="eventForm" action="{{ route('admin.event.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <select name="status" class="form-control">
                    ...
                    <option {{ $event->status == '1' ? 'selected' : '' }} value="1">{{ __('Activo') }}</option>
                    <option {{ $event->status == '0' ? 'selected' : '' }} value="0">{{ __('Inactivo') }}</option>
                  </select>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <select name="is_featured" class="form-control">
                    ...
                    <option value="yes" {{ $event->is_featured == 'yes' ? 'selected' : '' }}>{{ __('Sí') }}</option>
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <select name="organizer_id" class="form-control js-example-basic-single" required>
                    <option value="" selected>{{ __('Seleccioná un organizador') }}</option>
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <select name="discount_type" class="form-control discount_type">
                          ...
                          <option {{ optional($event->ticket)->early_bird_discount_type == 'fixed' ? 'selected' : '' }} value="fixed">{{ __('Monto fijo') }}</option>
                          <option {{ optional($event->ticket)->early_bird_discount_type == 'percentage' ? 'selected' : '' }} value="percentage">{{ __('Porcentaje') }}</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-lg-3">
        ...
        <div id="accordion" class="mt-2">
          @foreach ($languages as $language)
            <div class="version ev-section-card event-content-panel {{ $singleLanguageMode ? 'event-content-panel--single' : '' }}" style="margin-bottom:12px;">
                ...
                <div class="version-body p-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="{{ $language->code }}_country"
                            class="form-control"
                            placeholder="{{ __('Ej: Argentina') }}" value="{{ @$event_content->country }}">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="{{ __('Ej: C1043') }}" name="{{ $language->code }}_zip_code"
                            class="form-control"
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="descriptionTmce{{ $language->id }}" class="form-control summernote"
                      name="{{ $language->code }}_description" placeholder="{{ __('Contá de qué se trata el evento, qué incluye la entrada y cualquier dato importante.') }}"
                  ...
                  <div class="event-advanced-section mb-4">
                    <button type="button" class="event-advanced-toggle collapsed" data-toggle="collapse"
                      data-target="#eventSeoEditAdmin{{ $language->id }}" aria-expanded="false"
                      aria-controls="eventSeoEditAdmin{{ $language->id }}">
                      <span>
                    ...
                    <div id="eventSeoEditAdmin{{ $language->id }}" class="collapse event-advanced-body">
                      @include('partials.event-canonical-refund-policy')

                      <div class="form-group">
                        <label>{{ __('Palabras clave para Google') }}</label>
                        <input class="form-control" name="{{ $language->code }}_meta_keywords"
                          value="{{ @$event_content->meta_keywords }}" placeholder="{{ __('Ej: festival, buenos aires, música en vivo') }}"
                          data-role="tagsinput">
                      </div>
        ...
        {{-- ===== CARD: MULTIMEDIA ===== --}}
        <div class="card ev-section-card event-optional-card mt-2">
          <div class="card-header ev-section-header">
            <button type="button" class="event-optional-toggle collapsed" data-toggle="collapse"
              data-target="#eventMediaEditAdmin" aria-expanded="false" aria-controls="eventMediaEditAdmin">
              <span>
          ...
          <div class="card-body collapse" id="eventMediaEditAdmin">
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
        ...
        <div class="card ev-section-card event-optional-card mt-2">
          <div class="card-header ev-section-header">
            <button type="button" class="event-optional-toggle collapsed" data-toggle="collapse"
              data-target="#eventTrackingEditAdmin" aria-expanded="false" aria-controls="eventTrackingEditAdmin">
              <span>
          ...
          <div class="card-body collapse" id="eventTrackingEditAdmin">
            <div class="row">
              <div class="col-lg-4">
                <div class="form-group">
...
@section('style')
  <style>
    ...
    #my-dropzone .dz-message span::before {
      content: "{{ addslashes(__('Agregar imágenes adicionales')) }}";
      display: block;
      font-size: 15px;
      margin-bottom: 6px;
    }
    ...
    #my-dropzone .dz-message span::after {
      content: "{{ addslashes(__('Arrastralas acá o hacé clic para elegirlas. Son opcionales y complementan la portada.')) }}";
      display: block;
      font-size: 12px;
      font-weight: 500;
      color: #64748b;
