...
> Fuente: https://getbootstrap.com/docs/4.5/components/navbar/
...
[View on GitHub](https://github.com/twbs/bootstrap/blob/v4.5.3/site/docs/4.5/components/navbar.md "View and edit this file on GitHub")
...
Here’s what you need to know before getting started with the navbar:
  ...
  * Use our [spacing](/docs/4.5/utilities/spacing/) and [flex](/docs/4.5/utilities/flex/) utility classes for controlling spacing and alignment within navbars.
  * Navbars are responsive by default, but you can easily modify them to change that. Responsive behavior depends on our Collapse JavaScript plugin.
  * Navbars are hidden by default when printing. Force them to be printed by adding `.d-print` to the `.navbar`. See the [display](/docs/4.5/utilities/display/) utility class.
...
This example uses [color](/docs/4.5/utilities/colors/) (`bg-light`) and [spacing](/docs/4.5/utilities/spacing/) (`my-2`, `my-lg-0`, `mr-sm-0`, `my-sm-0`) utility classes.
...
Immediate children elements in `.navbar` use flex layout and will default to `justify-content: space-between`. Use additional [flex utilities](/docs/4.5/utilities/flex/) as needed to adjust this behavior.
...
Use our [position utilities](/docs/4.5/utilities/position/) to place navbars in non-static positions. Choose from fixed to the top, fixed to the bottom, or stickied to the top (scrolls with the page until it reaches the top, then stays there). Fixed navbars use `position: fixed`, meaning they’re pulled from the normal flow of the DOM and may require custom CSS (e.g., `padding-top` on the `<body>`) to prevent overlap with other elements.
