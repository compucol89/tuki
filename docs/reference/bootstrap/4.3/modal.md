...
> Fuente: https://getbootstrap.com/docs/4.3/components/modal/
...
Before getting started with Bootstrap’s modal component, be sure to read the following as our menu options have recently changed.
  ...
  * Once again, due to `position: fixed`, there are some caveats with using modals on mobile devices. [See our browser support docs](/docs/4.3/getting-started/browsers-devices/#modals-and-dropdowns-on-mobile) for details.
...
[Tooltips](/docs/4.3/components/tooltips/) and [popovers](/docs/4.3/components/popovers/) can be placed within modals as needed. When modals are closed, any tooltips and popovers within are also automatically dismissed.
