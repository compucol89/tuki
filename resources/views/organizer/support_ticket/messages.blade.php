          ...
          <div class="row">
            ...
            <div class="col-lg-3 offset-lg-5 mt-2 mt-lg-0 text-left text-lg-right">
              <a href="{{ route('organizer.support_tickets') }}"
                class="btn btn-primary btn-md">{{ __('Back to Lists') }}</a>
            </div>
          </div>
        </div>
        <div class="card-body">
            ...
            <div class="col-lg-12">
              ...
              <div class="row">
                <div class="col-lg-8 offset-lg-2">
                  <p class="support_ticket_description">{{ $ticket->description }}</p>
              ...
              @if (count($ticket->messages) > 0)
                @foreach ($ticket->messages as $reply)
                  ...
                  @else
                    @if ($reply->type == 3)
                      @php
                        $organizer = App\Models\Organizer::where('id', $reply->user_id)->first();
                      @endphp
                      <div class="item-list">
                        <div class="avatar">
                          @if ($organizer->photo)
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" name="file" class="custom-file-input"
                      data-href="{{ route('organizer.support_ticket.zip_file.upload') }}" name="file" id="zip_file"
                      accept=".zip">
