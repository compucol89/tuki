...
> Fuente: https://getbootstrap.com/docs/4.5/components/carousel/
...
[View on GitHub](https://github.com/twbs/bootstrap/blob/v4.5.3/site/docs/4.5/components/carousel.md "View and edit this file on GitHub")
...
Lastly, if you’re building our JavaScript from source, it [requires `util.js`](/docs/4.5/getting-started/javascript/#util).
